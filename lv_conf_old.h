...
#define LV_TICK_CUSTOM 0
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTO, input device read and animation step period.*/
 ...
 *The total number of draw units to allocate.
 *(One draw unit can render one widget.) */
...
/*Use SDL renderer API*/
#define LV_USE_DRAW_SDL 0e LV_USE_ASSERT_NULL          1   /*Check if the parameter is NULL. (Very fast, recommended)*/
 ...
 *Used if lvgl is bound to higher level language and t*/
#define LV_USE_MEM_MONITOR 0
#if LV_USE_MEM_MONITOR
    #define LV_USE_MEM_MONITOR_POS LV_ALIGN_BOTTOM_LEFT
#endif
